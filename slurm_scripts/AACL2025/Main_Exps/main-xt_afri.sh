...
#SBATCH --output=outfile/aacl-main-xt_afri-%j.out
...
for task in "xnli" "xtreme_r.udpos" "wikiann" "xquad"; do
    bash scripts/2025_aacl/run_langs_selection.sh "/home/bumie304/scratch/nlp_project/data" mix_opus100_nllb before_noaligner 31 xt_afri $task
done