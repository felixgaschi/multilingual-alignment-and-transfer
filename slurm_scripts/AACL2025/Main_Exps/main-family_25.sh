...
#SBATCH --output=outfile/aacl-main-family_25-%j.out
...
for task in "xnli" "xtreme_r.udpos" "wikiann" "xquad"; do
    bash scripts/2025_aacl/run_langs_selection.sh "/home/bumie304/scratch/nlp_project/data" mix_opus100_nllb before_noaligner 31 most_family_en_25 $task
done